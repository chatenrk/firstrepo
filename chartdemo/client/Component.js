jQuery.sap.declare("chart_demo.Component");

sap.ui.core.UIComponent.extend("chart_demo.Component", {
...
//		oView.setModel(oModel);
		...
		gModel = new sap.ui.model.json.JSONModel("model/linedata.json");
		gModel.setSizeLimit(2500);
		sap.ui.getCore().setModel(gModel, "linedata");

		gModel = new sap.ui.model.json.JSONModel("model/multiline.json");
		gModel.setSizeLimit(2500);
		sap.ui.getCore().setModel(gModel, "multilinedata");


		gModel = new sap.ui.model.json.JSONModel("model/areachart.json");
		gModel.setSizeLimit(2500);
		sap.ui.getCore().setModel(gModel, "areachart");

		gModel = new sap.ui.model.json.JSONModel("model/Piechart.json");
		gModel.setSizeLimit(2500);
		sap.ui.getCore().setModel(gModel, "Piechart");
