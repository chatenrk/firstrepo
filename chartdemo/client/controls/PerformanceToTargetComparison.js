...
jQuery.sap.declare("chart_demo.PerformanceToTargetComparison");

sap.ui.core.Element.extend("chart_demo.PerformanceToTargetComparisonItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("chart_demo.PerformanceToTargetComparison", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "PerformanceToTargetComparison Chart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.PerformanceToTargetComparisonItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("chart_demo.PerformanceToTargetComparison.init()");
		this.sParentId = "";
	},
	...
	createComparison : function() {
		 ...
		 */
		console.log("chart_demo.PerformanceToTargetComparison.createComparison()");
	...
	onAfterRendering: function(){
		console.log("chart_demo.PerformanceToTargetComparison.onAfterRendering()");
