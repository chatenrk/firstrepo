...
jQuery.sap.declare("chart_demo.AreaChart");

sap.ui.core.Element.extend("chart_demo.AreaChartItem", { metadata : {
	properties : {
		"date" : {type : "string", group : "Misc", defaultValue : null},
		"close" : {type : "string", group : "Misc", defaultValue : null}
	}
}});
sap.ui.core.Control.extend("chart_demo.AreaChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "Chart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.AreaChartItem", multiple : true, singularName : "item"}
		}
		,
