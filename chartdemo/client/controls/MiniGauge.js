...
jQuery.sap.declare("chart_demo.MiniGauge");

sap.ui.core.Element.extend("chart_demo.MiniGaugeItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("chart_demo.MiniGauge", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "Minigauge Chart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.MiniGaugeItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("chart_demo.MiniGauge.init()");
		this.sParentId = "";
	},
	
	
	createGauges : function() {
		console.log("chart_demo.MiniGauge.createGauges()");
	...
	onAfterRendering: function(){
		console.log("chart_demo.MiniGauge.onAfterRendering()");
		...
		chart.append("text")
		    ...
		    .attr("text-anchor", "middle")
		    .text(function(d) {
		    	var formattedFC = chart_demo.utils.Formatter.amount(d.forecast);
		    	return formattedFC;
			})
		   	.attr("font-family", "sans-serif")
		   	.attr("font-size", "14px")
		...
		chart.append("text")
		    ...
		    .attr("text-anchor", "middle")
		    .text(function(d) {
		    	var formattedBG = chart_demo.utils.Formatter.amount(d.budget);
		    	return formattedBG;
			})
		   	.attr("font-family", "sans-serif")
		   	.attr("font-size", "14px")
