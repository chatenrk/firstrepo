...
sap.ui.core.Element.extend("chart_demo.ChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("chart_demo.Chart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "Chart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.ChartItem", multiple : true, singularName : "item"}
		}
		,
