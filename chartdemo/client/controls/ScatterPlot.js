...
jQuery.sap.declare("chart_demo.ScatterPlot");

sap.ui.core.Element.extend("chart_demo.ScatterPlotItem", { metadata : {
	properties : {
		"quarter" : {type : "string", group : "Misc", defaultValue : null},
		"values" : {type : "object", group : "Misc", defaultValue : null}	
	}
}});	
sap.ui.core.Control.extend("chart_demo.ScatterPlot", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "ScatterPlot Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.ScatterPlotItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("chart_demo.ScatterPlot.init()");
		this.sParentId = "";
	},
	...
	createScatterPlot : function() {
		 ...
		 */
		console.log("chart_demo.ScatterPlot.createScatterPlot()");
	...
	onAfterRendering: function(){
		console.log("chart_demo.ScatterPlot.onAfterRendering()");
