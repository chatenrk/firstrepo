...
jQuery.sap.declare("chart_demo.HorizontalBarChart");

sap.ui.core.Element.extend("chart_demo.HorizontalBarChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("chart_demo.HorizontalBarChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "HorizontalBarChart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.HorizontalBarChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("chart_demo.HorizontalBarChart.init()");
		this.sParentId = "";
	},
	...
	createHorizontalBarChart : function() {
		 ...
		 */
		console.log("chart_demo.HorizontalBarChart.createHorizontalBarChart()");
	...
	onAfterRendering: function(){
		console.log("chart_demo.HorizontalBarChart.onAfterRendering()");
