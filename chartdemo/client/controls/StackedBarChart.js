...
jQuery.sap.declare("chart_demo.StackedBarChart");

sap.ui.core.Element.extend("chart_demo.StackedBarChartItem", { metadata : {
	properties : {
		"quarter" : {type : "string", group : "Misc", defaultValue : null},
		"values" : {type : "object", group : "Misc", defaultValue : null}	
	}
}});	
sap.ui.core.Control.extend("chart_demo.StackedBarChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "StackedBarChart Title"}
		},
		aggregations : {
			"items" : { type: "chart_demo.StackedBarChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("chart_demo.StackedBarChart.init()");
		this.sParentId = "";
	},
	...
	createStackedBarChart : function() {
		 ...
		 */
		console.log("chart_demo.StackedBarChart.createStackedBarChart()");
	...
	onAfterRendering: function(){
		console.log("chart_demo.StackedBarChart.onAfterRendering()");
