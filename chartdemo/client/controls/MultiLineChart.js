...
jQuery.sap.declare("chart_demo.MultiLineChart");

sap.ui.core.Element.extend("chart_demo.MultiLineChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("chart_demo.MultiLineChart", {
	metadata : {
		properties: {
