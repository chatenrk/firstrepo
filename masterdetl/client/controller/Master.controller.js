		...
		return BaseController.extend("sap.ui.demo.masterdetail.controller.Master", {
			...
			onInit : function () {
				...
				var oList = this.byId("list"),
					...
					// var prod_data = this.getOwnerComponent().getModel("products_data");
			...
			_onMasterMatched :  function() {
				...
				// 			return;
				// 		}
				// 		var id = mParams.firstListitem.getBindingContext().getProperty("id");
				// 		this.getRouter().navTo("object", {id :id}, true);
				// 	}.bind(this),
				// 	function (mParams) {
				// 		if (mParams.error) {
				// 			return;
				...
				// Set the first item id as this is the first invoke
				var prod_data = this.getOwnerComponent().getModel("products_data").getData();
				var id = prod_data.products[0].id;
				this.getRouter().navTo("object", {id :id}, true);
			},
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					id : oItem.getBindingContext("products_data").getProperty("id")
				}, bReplace);
			},
